import type { ConditionDirection } from '../enum/condition-direction.enum';
import type { HorizontalVertical } from '../enum/horizontal-vertical.enum';
import type { KeypointId } from '../enum/keypoint-id.enum';
import type { KeypointValueType } from '../enum/keypoint-value-type.enum';
import type { MoreLess } from '../enum/more-less.enum';

export type ExerciseAiPrescriptionString = {
...
export type ExerciseAiPrescription = {
  id: string;
  exerciseIds: string[];
  data: ExerciseAiPrescription;
};

type ExerciseAiPrescriptionData = {
...
type ExerciseRepStartCondition = {
