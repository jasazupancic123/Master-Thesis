...
export const Methods: Method[] = [
  ...
  },
  {
    ...
    attributes: [
      ...
      { field: 'tempoEcc', disabled: true },
      { field: 'tempoIso', disabled: true },
      { field: 'tempoCon', disabled: true },
      { field: 'tempoIdle', disabled: true },
      { field: 'recTime', min: 60, max: 60 },
    ],
  },
  {
  ...
  },
  {
    ...
    attributes: [
      ...
      { field: 'tempoEcc', min: 0, max: 10 },
      { field: 'tempoIso', min: 1, max: 3 },
      { field: 'tempoCon', min: 0, max: 1 },
      { field: 'tempoIdle', min: 0, max: 10 },
  ...
  },
  {
    ...
    attributes: [
      ...
      { field: 'reps', min: 5, max: 8 },
      { field: 'eff', min: 2, max: 3 },
      { field: 'tempoEcc', min: 4, max: 6 },
      { field: 'tempoIso', min: 1, max: 3 },
      { field: 'tempoCon', min: 4, max: 6 },
      { field: 'tempoIdle', min: 0, max: 4 },
      { field: 'recTime', min: 60, max: 90 },
    ],
  },
  ...
  },
  {
    ...
    attributes: [
      { field: 'sets', min: 3, max: 5 },
      { field: 'reps', min: 3, max: 5 },
      { field: 'tempoEcc', min: 2, max: 10 },
      { field: 'tempoIso', min: 2, max: 10 },
      { field: 'tempoCon', min: 2, max: 10 },
      { field: 'tempoIdle', min: 0, max: 0 },
  ...
  },
  {
    ...
    attributes: [
      ...
      { field: 'tempoEcc', min: 1, max: 9 },
      { field: 'tempoIso', min: 1, max: 2 },
      { field: 'tempoCon', min: 0, max: 0 },
      { field: 'tempoIdle', min: 1, max: 1 },
      { field: 'recTime', min: 60, max: 60 },
    ],
  },
  {
