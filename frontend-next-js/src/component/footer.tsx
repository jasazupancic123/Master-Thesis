...
import {SITE_MAIL} from "@/constant/website";
                ...
                >
                    ...
                    >
                        <Box sx={{width: {xs: '100%', sm: '60%'}}}>
                            <Box><Image src={LOGO_URL} width={200} height={50} alt="Logo"/></Box>
                            <Typography variant="body2" fontWeight={600} gutterBottom>Contact Us</Typography>
                            <Typography variant="body2" color="text.secondary" mb={2}>{SITE_MAIL}</Typography>
                        </Box>
                    </Box>
                    ...
                    >
                        ...
                        <Link color="text.secondary" href="#">Careers</Link>
                        <Link color="text.secondary" href="#">Press</Link>
                    </Box>
