...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory = {}) {
    ...
    wasmBinaryFile = 'vision_wasm_nosimd_internal.wasm';
    ...
    function _wgpuQueueSubmit(queueId, commandCount, commands) {
      ...
      var cmds = Array.from(
        HEAP32.subarray(commands >> 2, (commands >> 2) + commandCount),
        function (id) {
    ...
    function _wgpuQueueWriteBuffer(
      ...
      var bufferOffset =
        (bufferOffset_high >>> 0) * 4294967296 + (bufferOffset_low >>> 0);
      var subarray = HEAPU8.subarray(data, data + size);
      queue['writeBuffer'](buffer, bufferOffset, subarray, 0, size);
    }

    function _wgpuRenderPassEncoderDraw(
      passId,
      vertexCount,
      instanceCount,
      firstVertex,
    ...
    function _wgpuRenderPassEncoderSetBindGroup(
      passId,
      groupIndex,
      groupId,
      dynamicOffsetCount,
    ...
    var _free = (Module['_free'] = function () {
      return (_free = Module['_free'] = Module['asm']['md']).apply(
        null,
        arguments
      );
    });
    ...
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['nd']).apply(
        null,
        arguments
      );
    });

    var _addBoundTextureAsImageToStream = (Module[
      '_addBoundTextureAsImageToStream'
    ] = function () {
      return (_addBoundTextureAsImageToStream = Module[
        '_addBoundTextureAsImageToStream'
      ] =
    ...
    var _attachImageListener = (Module['_attachImageListener'] = function () {
      return (_attachImageListener = Module['_attachImageListener'] =
        Module['asm']['pd']).apply(null, arguments);
    });

    var _attachImageVectorListener = (Module['_attachImageVectorListener'] =
      function () {
        return (_attachImageVectorListener = Module[
    ...
    var _registerModelResourcesGraphService = (Module[
      ...
      return (_registerModelResourcesGraphService = Module[
        '_registerModelResourcesGraphService'
      ] =
    ...
    var _addBoolToInputSidePacket = (Module['_addBoolToInputSidePacket'] =
      function () {
        return (_addBoolToInputSidePacket = Module[
    ...
    var _addDoubleToInputSidePacket = (Module['_addDoubleToInputSidePacket'] =
      function () {
        return (_addDoubleToInputSidePacket = Module[
    ...
    var _addFloatToInputSidePacket = (Module['_addFloatToInputSidePacket'] =
      function () {
        return (_addFloatToInputSidePacket = Module[
    ...
    var _addIntToInputSidePacket = (Module['_addIntToInputSidePacket'] =
      function () {
        return (_addIntToInputSidePacket = Module['_addIntToInputSidePacket'] =
          Module['asm']['Gd']).apply(null, arguments);
      });

    var _addStringToInputSidePacket = (Module['_addStringToInputSidePacket'] =
      function () {
        return (_addStringToInputSidePacket = Module[
    ...
    var _addProtoToInputSidePacket = (Module['_addProtoToInputSidePacket'] =
      function () {
        return (_addProtoToInputSidePacket = Module[
    ...
    var _attachIntListener = (Module['_attachIntListener'] = function () {
      return (_attachIntListener = Module['_attachIntListener'] =
        Module['asm']['Pd']).apply(null, arguments);
    });

    var _attachIntVectorListener = (Module['_attachIntVectorListener'] =
      function () {
        return (_attachIntVectorListener = Module['_attachIntVectorListener'] =
          Module['asm']['Qd']).apply(null, arguments);
      });

    var _attachStringListener = (Module['_attachStringListener'] = function () {
      return (_attachStringListener = Module['_attachStringListener'] =
        Module['asm']['Rd']).apply(null, arguments);
    });

    var _attachStringVectorListener = (Module['_attachStringVectorListener'] =
      function () {
        return (_attachStringVectorListener = Module[
    ...
    var _attachProtoVectorListener = (Module['_attachProtoVectorListener'] =
      function () {
        return (_attachProtoVectorListener = Module[
    ...
    var _process = (Module['_process'] = function () {
      return (_process = Module['_process'] = Module['asm']['ae']).apply(
        null,
        arguments
      );
    });
    ...
    var _bindTextureToCanvas = (Module['_bindTextureToCanvas'] = function () {
      return (_bindTextureToCanvas = Module['_bindTextureToCanvas'] =
    ...
    var _requestShaderRefreshOnGraphChange = (Module[
      ...
      return (_requestShaderRefreshOnGraphChange = Module[
        '_requestShaderRefreshOnGraphChange'
      ] =
    ...
    var _waitUntilIdle = (Module['_waitUntilIdle'] = function () {
      return (_waitUntilIdle = Module['_waitUntilIdle'] =
        Module['asm']['de']).apply(null, arguments);
    });

    var _closeGraph = (Module['_closeGraph'] = function () {
      return (_closeGraph = Module['_closeGraph'] = Module['asm']['ee']).apply(
        null,
        arguments
      );
    });

    var _setAutoRenderToScreen = (Module['_setAutoRenderToScreen'] =
      function () {
        return (_setAutoRenderToScreen = Module['_setAutoRenderToScreen'] =
    ...
    var __emscripten_timeout = function () {
      return (__emscripten_timeout = Module['asm']['ie']).apply(
        null,
        arguments
      );
    };
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module['asm']['je']).apply(
        null,
        arguments
      );
    };
    ...
    var ___cxa_is_pointer_type = function () {
      return (___cxa_is_pointer_type = Module['asm']['ne']).apply(
        null,
        arguments
      );
    };
...
else if (typeof exports === 'object') exports['ModuleFactory'] = ModuleFactory;
