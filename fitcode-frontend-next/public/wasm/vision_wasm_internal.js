...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory = {}) {
    ...
    var _free = (Module['_free'] = function () {
      return (_free = Module['_free'] = Module['asm']['od']).apply(
        null,
        arguments
      );
    });
    ...
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['pd']).apply(
        null,
        arguments
      );
    });
    ...
    var _processGl = (Module['_processGl'] = function () {
      return (_processGl = Module['_processGl'] = Module['asm']['be']).apply(
        null,
        arguments
      );
    });
    ...
    var _process = (Module['_process'] = function () {
      return (_process = Module['_process'] = Module['asm']['ce']).apply(
        null,
        arguments
      );
    });
    ...
    var _closeGraph = (Module['_closeGraph'] = function () {
      return (_closeGraph = Module['_closeGraph'] = Module['asm']['ge']).apply(
        null,
        arguments
      );
    });
    ...
    var __emscripten_timeout = function () {
      return (__emscripten_timeout = Module['asm']['ke']).apply(
        null,
        arguments
      );
    };
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module['asm']['le']).apply(
        null,
        arguments
      );
    };
    ...
    var ___cxa_is_pointer_type = function () {
      return (___cxa_is_pointer_type = Module['asm']['pe']).apply(
        null,
        arguments
      );
    };
