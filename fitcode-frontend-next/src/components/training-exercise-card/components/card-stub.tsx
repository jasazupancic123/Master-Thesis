...
import StubTrainingExerciseCardCollapsedSets from './collapsed-sets-stub';
import type { TrainingExerciseCardProps } from '@/components/trainer-group-day-view/props/props';
import { useScreenSize } from '@/store/screen-size.provider';
import { useTrainerDayView } from '@/store/trainer-day-view.provider';

export default function TrainingExerciseCardStub(
  ...
  const { training, component, selectedExerciseIds } = useTrainerDayView();
