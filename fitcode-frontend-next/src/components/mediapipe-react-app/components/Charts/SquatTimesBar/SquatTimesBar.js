...
export const SquatTimesBar = ({ downTime, upTime }) => {
  ...
  return (
    <div
      className="squat-times-bar-container"
      style={{ '--downTimeWidth': downTimeWidth, '--upTimeWidth': upTimeWidth }}
    >
      <div className="down-time">{downTime} ms</div>
      <div className="up-time">{upTime} ms</div>
    </div>
  );
};
