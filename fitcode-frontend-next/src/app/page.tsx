            ...
            <Grid item xs={12} sm={10} md={8}>
              <Paper elevation={3} sx={titleStyle}>
                ...
                >
                  ...
                  training load of your team or individual athletes. Turn the
                  gym blind spot into a well-defined training space with our
            ...
            <Grid item xs={12} sm={10} md={8}>
              <Paper elevation={3} sx={titleStyle}>
                ...
                >
                  ...
                  progress monitoring) with a vibrant community, fostering
                  lasting program attachment and driving results. Whether
                  seasoned athletes or fitness newbies, your clients will be
                  empowered by personalized training plans and a supportive
                  environment that fuels motivation and celebrates success.
                  FitCode Life: Where innovation meets community for lifelong
                  wellness.
                </Typography>
