...
from fe_lib.subsystems.authentication.face_detection.scrfd.schemas import Threshold
...
class SCRFDBase:
    ...
    def detect(
        ...
        scores_list, bboxes_list, kpss_list = self.forward(det_img, threshold.probability)
